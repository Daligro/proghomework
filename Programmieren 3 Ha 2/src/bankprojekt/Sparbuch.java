...
public class Sparbuch extends Konto {
	...
	public boolean abheben (double betrag) throws GesperrtException{
		...
		{
			setKontostand(getKontostand() - betrag*getAktuelleWaehrung().kurs);
			bereitsAbgehoben += betrag*getAktuelleWaehrung().kurs;
	...
	public void waehrungswechsel(Waehrung neu){
		bereitsAbgehoben=bereitsAbgehoben/this.getAktuelleWaehrung().kurs*neu.kurs;
