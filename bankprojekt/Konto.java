...
public abstract class Konto 
{
	...
	/**
	 * hebt den gewünschten betrag in währung w ab
	 * @param betrag gewünschter betrag
	 * @param w Währung die abgehoben wird
	...
	/**
	 * gibt die waehrung aus in der das Konto geführt wird
	 * @return waehrung in der das Konto geführt wird
	 */
